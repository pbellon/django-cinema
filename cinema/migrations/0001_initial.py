    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Rumored', 'Rumored'), ('In Production', 'In Production'), ('Post Production', 'Post Production'), ('Released', 'Released'), ('Canceled', 'Canceled')], max_length=15)),
                ('budget', models.IntegerField(validators=[django.core.validators.MinValueValidator(limit_value=0, message="Budget can't be negative")])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('score', models.DecimalField(decimal_places=1, help_text='Evaluation score', max_digits=3, validators=[django.core.validators.MinValueValidator(limit_value=0, message='Score must be superior or equal to 0'), django.core.validators.MaxValueValidator(limit_value=10, message='Score must be inferior or equal to 10')])),
