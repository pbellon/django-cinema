    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tmdb_population_date', models.DateTimeField(blank=True, null=True)),
                ('creation_source', models.CharField(choices=[('ADMIN', 'Admin'), ('TMDB', 'TMDb')], default='ADMIN', editable=False, max_length=5)),
            ],
            options={
                'verbose_name': 'Author',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('biography', models.TextField(blank=True)),
                ('favorite_authors', models.ManyToManyField(related_name='favorited_by', to='cinema.author')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='favorited_by', to='cinema.movie'),
        ),
    ]
